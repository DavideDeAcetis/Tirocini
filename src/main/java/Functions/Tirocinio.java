...
public class Tirocinio implements Colors {
    public static int attivazione_tirocinio(Connection con) throws SQLException {
        System.out.println(Colors.CYAN + "Menu per l'attivazione di una tirocinio. " +
                "\nInserire" + Colors.RED + " 0 " + Colors.CYAN + "in qualsiasi momento per annullare la procedura." +
